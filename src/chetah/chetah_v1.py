...
class BM25:
    ...
    def fit(self, X):
        ...
        y = super(TfidfVectorizer, self.vectorizer).transform(X)  # type: ignore
    ...
    def transform(self, q, X):
        ...
        X = super(TfidfVectorizer, self.vectorizer).transform(X)  # type: ignore
        len_X = X.sum(1).A1
        (q,) = super(TfidfVectorizer, self.vectorizer).transform([q])  # type: ignore
