...
with open(configuration.get("chetah", "inv_path")) as f:
    inv_index = json.load(f)

with open(configuration.get("chetah", "doc_path")) as f:
...
class BM25F:
    ...
    def calculate_bm25F(self, query_term_ids):
        ...
        lenz = [
            [inv_index["doc_prop"][x]["content_length"], inv_index["doc_prop"][x]["metadata_length"]] for x in docs_set
        ]
