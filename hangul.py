...
print("tika: ", sys.getsizeof(tika))
print("parser: ", sys.getsizeof(parser))
print("spacy: ", sys.getsizeof(spacy))
# print("get_disasters: ", sys.getsizeof(get_disasters))
# print("extract_metadata: ", sys.getsizeof(extract_metadata))
print("detected_potential_countries: ", sys.getsizeof(detected_potential_countries))
print("detect_report_type: ", sys.getsizeof(detect_report_type))
# print("generate_keywords: ", sys.getsizeof(generate_keywords))
# print("get_lang_name: ", sys.getsizeof(get_lang_name))
# print("get_markdown: ", sys.getsizeof(get_markdown))
print("theme_detection: ", sys.getsizeof(theme_detection))
#print("extract_fontsize_title: ", sys.getsizeof(extract_fontsize_title))
# print("textrank_sentences: ", sys.getsizeof(textrank_sentences))
# print("summary_generation: ", sys.getsizeof(summary_generation))
# print("new_disaster_detection: ", sys.getsizeof(new_disaster_detection))
...
# print("nlp out func: ", nlp, "memory: ", sys.getsizeof(nlp))
...
def detect_second_version(file: UploadFile, kw_num: int):
    ...
    del html_to_markdown
    gc.collect()

    locations = detected_potential_countries(cleaned_content)
    
    import disaster_detection #import get_disasters
    disasters = disaster_detection.get_disasters(cleaned_content)
    del disaster_detection
    gc.collect()
